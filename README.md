...
This dataset contains 16 columns and 2,512 samples of transaction data, covering a wide range of transaction attributes, customer demographics, and activity patterns. Every entry provides comprehensive insights into the transaction behavior, making it a robust foundation for building predictive models and enhancing financial security through anomaly detection.  
